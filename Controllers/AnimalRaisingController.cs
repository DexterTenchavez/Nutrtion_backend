...
{
    [ApiController]
    [Route("api/ReportDataEntry/animal-raising")]
    [Authorize(Roles = "admin,staff")]
    public class AnimalRaisingController : ControllerBase
    {
        private readonly IAnimalRaisingService _service;

        public AnimalRaisingController(IAnimalRaisingService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] AnimalRaisingEntryDto dto)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] AnimalRaisingEntryDto dto)
        {
            try
            {
